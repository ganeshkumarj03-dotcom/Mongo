    ...
    <div className="min-h-screen bg-white text-pawzy-dark font-sans flex flex-col">
      ...
      <header className="absolute top-0 left-0 right-0 z-50 bg-[#e2eae6]/70 backdrop-blur-md transition-all duration-300">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-8">
            ...
            <a href="#" className="text-slate-700 hover:text-pawzy-green font-semibold transition-colors">Features</a>
      ...
      <section className="bg-white py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <img
            src="/Group 1000003106.png"
            alt="Ready to pamper your pet? Scan to Download Pawzy App."
            className="w-full h-auto rounded-[2.5rem] shadow-xl hover:shadow-2xl transition-shadow duration-300 select-none object-cover"
          />
        </div>
      </section>
